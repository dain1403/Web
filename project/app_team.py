...
@app.route('/')
def index():
    menu = {'home':True, 'rgrs':False, 'stmt':False, 'clsf':False, 'clst':False, 'mail':False, 'user':False}
...
@app.route('/regression', methods=['GET', 'POST'])
def regression():
    menu = {'home':False, 'rgrs':True, 'stmt':False, 'clsf':False, 'clst':False, 'mail':False, 'user':False}
    if request.method == 'GET':
        return render_template('regression.html', menu=menu)
    else:
        sp_names = ['Setosa', 'Versicolor', 'Virginica']
...
def sentiment():
    menu = {'home':False, 'rgrs':False, 'stmt':True, 'clsf':False, 'clst':False, 'mail':False, 'user':False}
    if request.method == 'GET':
...
def classification():
    menu = {'home':False, 'rgrs':False, 'stmt':False, 'clsf':True, 'clst':False, 'mail':False, 'user':False}
    if request.method == 'GET':
...
def clustering():
    menu = {'home':False, 'rgrs':False, 'stmt':False, 'clsf':False, 'clst':True, 'mail':False, 'user':False}
    if request.method=='GET':
...
def spam():
    menu = {'home':False, 'rgrs':False, 'stmt':False, 'clsf':False, 'clst':False, 'mail':True, 'user':False}
    if request.method=='GET':
        return render_template('spam.html', menu=menu)
    else:
        ncls = float(request.form['acc'])
        return render_template('spam_result.html', menu=menu, acc = ncls)
